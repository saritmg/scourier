    ...
    <div id="content"> 
		<div id="home" class="section">
            ...
            <div class="box home_box1 color1">
            	<a href="#services"><img src="images/emp.jpg" alt="Services" /></a>
            </div>
            
            <div class="box home_box1 color2">
	            <a href="#testimonial"><img src="images/empremove.jpg" alt="Testimonial" /></a>
            </div>
            
            <div class="box home_box2 color3" onclick="addc.php">
            	<div id="addc" onclick="addc.php">
                    <a href="report.php"><img src="images/viewcour.png"></a>
              ...
              <tbody>
                ...
                <tr bgcolor="EFEFEF">
                  <td valign="top"><div align="center">
                    ...
                    <span class="gentxt style1">Eg: Sarita </span> </div></td>
                </tr>
                <tr bgcolor="EFEFEF">
                  <td valign="top">&nbsp;</td>
                </tr>
...
<div id="templatemo_footer">
    Copyright © 2017 | Saaku Services Courier </a>
</div>
